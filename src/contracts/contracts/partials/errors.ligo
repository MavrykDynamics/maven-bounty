...
[@inline] const error_BOUNTY_CANNOT_BE_COMPLETED                                                                        = 71n;
[@inline] const error_BOUNTY_IS_ALREADY_PENDING_REVIEW                                                                  = 72n;
[@inline] const error_MILESTONE_NEEDS_TO_BE_SPECIFIED_TO_SEND_BOUNTY_REWARD                                             = 73n;
[@inline] const error_USER_HAS_ALREADY_APPLIED_FOR_THIS_BOUNTY                                                          = 74n;
[@inline] const error_GROUP_CREATOR_CANNOT_REMOVE_HIMSELF                                                               = 75n;

[@inline] const error_SET_BOUNTY_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                                   = 76n;
[@inline] const error_TOGGLE_PAUSE_BOUNTY_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                          = 77n;
[@inline] const error_APPROVE_OR_REJECT_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                            = 78n;
[@inline] const error_REVIEW_BOUNTY_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                                = 79n;
[@inline] const error_SEND_BOUNTY_REWARD_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                           = 80n;
[@inline] const error_APPLY_FOR_BOUNTY_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                             = 81n;
[@inline] const error_CANCEL_APPLICATION_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                           = 82n;
[@inline] const error_COMPLETE_BOUNTY_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                              = 83n;
[@inline] const error_STOP_BOUNTY_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                                  = 84n;
[@inline] const error_FORM_GROUP_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                                   = 85n;
[@inline] const error_ADD_GROUP_MEMBER_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                             = 86n;
[@inline] const error_CONFIRM_GROUP_MEMBERSHIP_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                     = 87n;
[@inline] const error_LEAVE_GROUP_ENTRYPOINT_IN_BOUNTY_CONTRACT_PAUSED                                                  = 88n;

[@inline] const error_MEMBER_DID_NOT_APPLY_FOR_GROUP                                                                    = 89n;
[@inline] const error_SENDER_IS_ALREADY_GROUP_MEMBER                                                                    = 90n;
